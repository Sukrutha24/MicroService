 ...
 <div 
         ...
         <security:authorize access="!isAuthenticated()">  
				...
				<div class="container-fluid">
			        <div class="navbar-header">
			            ...
			            <a class="navbar-brand" href="http://www.innovator-learning.com">
			                <img alt="innovator Trader" src="images/logo1.png" width="120px;"/>
			            </a>
			        </div>
			            ...
			            <ul class="nav navbar-nav navbar-right">
			                <li>
			                    <a class="navbar-brand" href="#">
			                        <img alt="innovator Trader" width="220px;"/>
			                    </a>
			                </li>
			            </ul>
					</div>
    ...
    <div 
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://www.innovator-learning.com">
			                <img alt="innovator Trader" src="images/logo.png" width="120px;"/>
			            </a>
        </div>
