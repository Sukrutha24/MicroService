...
public class Security {
	...
	public int hashCode() {
		...
		result = prime * result + ((categoryOrIndustry == null) ? 0 : categoryOrIndustry.hashCode());
		result = prime * result + ((market == null) ? 0 : market.hashCode());
		result = prime * result + ((marketIdentificationCode == null) ? 0 : marketIdentificationCode.hashCode());
		result = prime * result + ((mostLiquidExchange == null) ? 0 : mostLiquidExchange.hashCode());
		result = prime * result + ((name == null) ? 0 : name.hashCode());
		result = prime * result + ((valoren == null) ? 0 : valoren.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (marketIdentificationCode == null) {
			if (other.marketIdentificationCode != null)
				return false;
		} else if (!marketIdentificationCode.equals(other.marketIdentificationCode))
			return false;
