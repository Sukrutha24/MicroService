...
public class YahooQuote {
	/*
	 * { "symbol": "IBM", "Ask": "140.25", "AverageDailyVolume": "4611000", "Bid":
	 * "139.34", "AskRealtime": null, "BidRealtime": null, "BookValue": "13.70",
	 * "Change_PercentChange": "+0.29 - +0.21%", "Change": "+0.29", "Commission":
	 * null, "Currency": "USD", "ChangeRealtime": null, "AfterHoursChangeRealtime":
	 * null, "DividendShare": "5.20", "LastTradeDate": "11/2/2015", "TradeDate":
	 * null, "EarningsShare": "14.37",
	 * "ErrorIndicationreturnedforsymbolchangedinvalid": null,
	 * "EPSEstimateCurrentYear": "14.93", "EPSEstimateNextYear": "15.10",
	 * "EPSEstimateNextQuarter": "2.94", "DaysLow": "139.57", "DaysHigh": "140.52",
	 * "YearLow": "137.33", "YearHigh": "176.30", "HoldingsGainPercent": null,
	 ...
	 * null, "MarketCapitalization": "136.17B", "MarketCapRealtime": null, "EBITDA":
	 * "21.41B", "ChangeFromYearLow": "3.04", "PercentChangeFromYearLow": "+2.21%",
	 ...
	 * "PreviousClose": "140.08", "PricePaid": null, "ChangeinPercent": "+0.21%",
	 * "PriceSales": "1.62", "PriceBook": "10.22", "ExDividendDate": "8/6/2015",
	 * "PERatio": "9.77", "DividendPayDate": "12/10/2015", "PERatioRealtime": null,
	 * "PEGRatio": "1.29", "PriceEPSEstimateCurrentYear": "9.40",
	 * "PriceEPSEstimateNextYear": "9.30", "Symbol": "IBM", "SharesOwned": null,
	 * "ShortRatio": "6.62", "LastTradeTime": "4:02pm", "TickerTrend": null,
	 * "OneyrTargetPrice": "149.17", "Volume": "3822267", "HoldingsValue": null,
	 * "HoldingsValueRealtime": null, "YearRange": "137.33 - 176.30",
	 * "DaysValueChange": null, "DaysValueChangeRealtime": null, "StockExchange":
	 * "NYQ", "DividendYield": "3.71", "PercentChange": "+0.21%" }
	 */
	...
	public String toString() {
		...
		builder.append("YahooQuote [symbol=").append(symbol).append(", ask=").append(ask)
				.append(", averageDailyVolume=").append(averageDailyVolume).append(", bid=").append(bid)
				.append(", askRealtime=").append(askRealtime).append(", bidRealtime=").append(bidRealtime)
				.append(", bookValue=").append(bookValue).append(", change_PercentChange=").append(change_PercentChange)
				.append(", commission=").append(commission).append(", currency=").append(currency)
				.append(", changeRealTime=").append(changeRealTime).append(", afterHoursChangeRealtime=")
				.append(afterHoursChangeRealtime).append(", dividendShare=").append(dividendShare)
				.append(", tradeDate=").append(tradeDate).append(", earningsShare=").append(earningsShare)
				.append(", errorIndicationreturnedforsymbolchangedinvalid=")
				.append(errorIndicationreturnedforsymbolchangedinvalid).append(", ePSEstimateCurrentYear=")
				.append(ePSEstimateCurrentYear).append(", ePSEstimateNextYear=").append(ePSEstimateNextYear)
				.append(", ePSEstimateNextQuarter=").append(ePSEstimateNextQuarter).append(", daysLow=").append(daysLow)
				.append(", daysHigh=").append(daysHigh).append(", yearLow=").append(yearLow).append(", yearHigh=")
				.append(yearHigh).append(", holdingsGainPercent=").append(holdingsGainPercent)
				.append(", annualizedGain=").append(annualizedGain).append(", holdingsGain=").append(holdingsGain)
				.append(", holdingsGainPercentRealtime=").append(holdingsGainPercentRealtime)
				.append(", holdingsGainRealtime=").append(holdingsGainRealtime).append(", moreInfo=").append(moreInfo)
				.append(", orderBookRealtime=").append(orderBookRealtime).append(", marketCapitalization=")
				.append(marketCapitalization).append(", marketCapRealtime=").append(marketCapRealtime)
				.append(", eBITDA=").append(eBITDA).append(", changeFromYearLow=").append(changeFromYearLow)
				.append(", percentChangeFromYearLow=").append(percentChangeFromYearLow)
				.append(", lastTradeRealtimeWithTime=").append(lastTradeRealtimeWithTime)
				.append(", changePercentRealtime=").append(changePercentRealtime).append(", changeFromYearHigh=")
				.append(changeFromYearHigh).append(", percebtChangeFromYearHigh=").append(percebtChangeFromYearHigh)
				.append(", lastTradeWithTime=").append(lastTradeWithTime).append(", lastTradePriceOnly=")
				.append(lastTradePriceOnly).append(", highLimit=").append(highLimit).append(", lowLimit=")
				.append(lowLimit).append(", daysRange=").append(daysRange).append(", daysRangeRealtime=")
				.append(daysRangeRealtime).append(", fiftydayMovingAverage=").append(fiftydayMovingAverage)
				.append(", twoHundreddayMovingAverage=").append(twoHundreddayMovingAverage)
				.append(", changeFromTwoHundreddayMovingAverage=").append(changeFromTwoHundreddayMovingAverage)
				.append(", percentChangeFromTwoHundreddayMovingAverage=")
				.append(percentChangeFromTwoHundreddayMovingAverage).append(", changeFromFiftydayMovingAverage=")
				.append(changeFromFiftydayMovingAverage).append(", percentChangeFromFiftydayMovingAverage=")
				.append(percentChangeFromFiftydayMovingAverage).append(", name=").append(name).append(", notes=")
				.append(notes).append(", open=").append(open).append(", previousClose=").append(previousClose)
				.append(", pricePaid=").append(pricePaid).append(", changeinPercent=").append(changeinPercent)
				.append(", priceSales=").append(priceSales).append(", priceBook=").append(priceBook)
				.append(", exDividendDate=").append(exDividendDate).append(", pERatio=").append(pERatio)
				.append(", dividendPayDate=").append(dividendPayDate).append(", pERatioRealtime=")
				.append(pERatioRealtime).append(", pEGRatio=").append(pEGRatio).append(", priceEPSEstimateCurrentYear=")
				.append(priceEPSEstimateCurrentYear).append(", priceEPSEstimateNextYear=")
				.append(priceEPSEstimateNextYear).append(", sharesOwned=").append(sharesOwned).append(", shortRatio=")
				.append(shortRatio).append(", lastTradeTime=").append(lastTradeTime).append(", lastTradeDate=")
				.append(lastTradeDate).append(", tickerTrend=").append(tickerTrend).append(", oneyrTargetPrice=")
				.append(oneyrTargetPrice).append(", volume=").append(volume).append(", holdingsValue=")
				.append(holdingsValue).append(", holdingsValueRealtime=").append(holdingsValueRealtime)
				.append(", yearRange=").append(yearRange).append(", daysValueChange=").append(daysValueChange)
				.append(", daysValueChangeRealtime=").append(daysValueChangeRealtime).append(", stockExchange=")
				.append(stockExchange).append(", dividendYield=").append(dividendYield).append(", percentChange=")
				.append(percentChange).append(", change=").append(change).append("]");
