...
public class MarketSummary {
	...
	public String toString() {
		...
		builder.append("MarketSummary [topLosers=").append(topLosers).append(", topGainers=").append(topGainers)
				.append(", tradeStockIndexAverage=").append(tradeStockIndexAverage).append(", tradeStockIndexVolume=")
				.append(tradeStockIndexVolume).append(", tradeStockIndexOpenAverage=")
				.append(tradeStockIndexOpenAverage).append(", change=").append(change).append(", percentGain=")
				.append(percentGain).append(", summaryDate=").append(summaryDate).append("]");
