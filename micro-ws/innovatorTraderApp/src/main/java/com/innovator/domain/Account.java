...
public class Account implements Serializable {
	...
	public String toString() {
		...
		builder.append("Account [id=").append(id).append(", address=").append(address).append(", passwd=")
				.append("PASSWD OMMITED").append(", userid=").append(userid).append(", email=").append(email)
				.append(", creditcard=").append(creditcard).append(", fullname=").append(fullname)
				.append(", authtoken=").append(authtoken).append(", creationdate=").append(creationdate)
				.append(", openbalance=").append(openbalance).append(", logoutcount=").append(logoutcount)
				.append(", balance=").append(balance).append(", lastlogin=").append(lastlogin).append(", logincount=")
	...
	public int hashCode() {
		...
		result = prime * result + ((logoutcount == null) ? 0 : logoutcount.hashCode());
