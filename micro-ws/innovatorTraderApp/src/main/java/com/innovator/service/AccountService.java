...
import com.innovator.exception.AuthenticationException;
import com.innovator.exception.NoRecordsFoundException;
...
public class AccountService {
	...
	/**
	 * Retrieve an account with given id. The id here is the unique id value of the
	...
	public Account findAccount(Integer id) {
		...
		logger.info(String.format("AccountService.findAccount - retrieved account with id: %s. Payload is: %s", id,
				account));
	...
	/**
	 * Retrieve an account with given id. The id here is the unique user id value of
	 * the account, ie the username.
	 * 
	...
	/**
	 * Retrieves the account by the authorization token associated with that account
	 * and current login.
	 * 
	 ...
	 * AuthenticationException if an account with the given username and password
	 * cannot be found.
	 * 
