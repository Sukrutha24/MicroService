...
import com.innovator.domain.AuthenticationRequest;
...
public class UserService {
	...
	public void createAccount(Account account) {
		...
		// String status = restTemplate.postForObject("http://" + accountsService +
		// "/account/", account, String.class);
		// logger.info("Status from registering account for "+ account.getUserid()+ " is
		// " + status);
	}
