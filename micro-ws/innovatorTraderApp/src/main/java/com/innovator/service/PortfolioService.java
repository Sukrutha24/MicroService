...
import com.innovator.domain.Holding;
import com.innovator.domain.Order;
import com.innovator.domain.OrderType;
import com.innovator.domain.Portfolio;
import com.innovator.domain.Quote;
import com.innovator.exception.OrderNotSavedException;
import com.innovator.exception.SymbolNotFoundException;
import com.innovator.repository.OrderRepository;
...
public class PortfolioService {
	...
	public Portfolio getPortfolio(String accountId) throws SymbolNotFoundException {
		/*
		 * Retrieve all orders for accounts id and build portfolio. - for each order
		 * create holding. - for each holding find current price.
		 */
